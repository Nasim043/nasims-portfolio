...
const Home = () => {
    return (
        <div className="px-4 pb-4 md:px-16 lg:px-8 lg:pb-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl mb-6 pt-24 text-gray-500 text-center min-h-[420px]" name="home">
            <div data-aos="fade-down" data-aos-duration="1000" data-aos-mirror="true" className="">
